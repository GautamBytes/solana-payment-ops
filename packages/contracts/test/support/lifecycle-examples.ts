...
export const TEST_EVENT_ID = "00000000-0000-4000-8000-000000000001";
...
export const TEST_OCCURRED_AT = "2026-08-11T12:00:00.000Z";

export const lifecycleExamples = [
  lifecycle("invoice.issued", "invoice", "invoice-001", {
  ...
  lifecycle("invoice.cancelled", "invoice", "invoice-001", {
    invoiceId: "invoice-001",
    publicReference: "INV-2026-001",
    previousState: "issued",
    reasonCode: "customer_request",
    actorKind: "member",
    cancelledAt: TEST_OCCURRED_AT,
  }),
  ...
  lifecycle("payment.confirmation_revoked", "payment", "attempt-001", {
  ...
  lifecycle("payment.exception_created", "payment_exception", "exception-001", {
  ...
  lifecycle("invoice.partial", "invoice", "invoice-001", {
    invoiceId: "invoice-001",
    customerId: "customer-001",
    eventId: "chain-event-001",
  ...
  lifecycle("invoice.paid", "invoice", "invoice-001", {
    invoiceId: "invoice-001",
    customerId: "customer-001",
    eventId: "chain-event-001",
    signature: TEST_SIGNATURE,
  ...
  lifecycle("invoice.overpaid", "invoice", "invoice-001", {
    invoiceId: "invoice-001",
    customerId: "customer-001",
    eventId: "chain-event-001",
  ...
  lifecycle("refund.prepared", "refund", "refund-001", {
    refundId: "refund-001",
    invoiceId: "invoice-001",
  ...
  lifecycle("refund.finalized", "refund", "refund-001", {
    refundId: "refund-001",
    invoiceId: "invoice-001",
    signature: TEST_SIGNATURE,
  ...
  lifecycle("evidence.ready", "evidence_pack", "evidence-001", {
...
] as const satisfies readonly LifecycleEventEnvelope[];
...
function lifecycle(
  ...
  return {
    ...
    statusAtOccurrence: type.split(".").at(-1)!,
    object: { type: objectType, id: objectId, version: 1 },
    data,
  } as unknown as LifecycleEventEnvelope;
}
...
function paymentObserved(
  ...
  return lifecycle(type, "payment", "attempt-001", {
    paymentAttemptId: "attempt-001",
    invoiceId: "invoice-001",
    eventId: "chain-event-001",
    signature: TEST_SIGNATURE,
